<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <SizeIdManager offline label="SizeId" v-model="value.sizeId" :editMode="editMode" @change="change"/>
            <MachineSize offline label="MachineSize" v-model="value.machineSize" :editMode="editMode" @change="change"/>
        </v-card-text>
