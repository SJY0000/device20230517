<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <SizeIdManager offline label="SizeId" v-model="item.sizeId" :editMode="false" @change="change" />
            <MachineSize offline label="MachineSize" v-model="item.machineSize" :editMode="false" :key="false" @change="change" />
        </v-card-text>
